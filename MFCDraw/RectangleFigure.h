...
public:
	...
	RectangleFigure(const Utility::Color& color, const CPoint& ptTopLeft, BOOL bFilled);
...
private:
	enum {
			CREATE_RECTANGLE, MODIFY_TOPLEFT, MODIFY_TOPRIGHT,
			MODIFY_BOTTOMRIGHT, MODIFY_BOTTOMLEFT, MOVE_RECTANGLE
		 } m_eDragMode;
protected:
