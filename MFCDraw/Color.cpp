...
namespace Utility
{
	...
	Color::Color()
		: m_crRedGreenBlue(RGB(0, 0, 0))
	{
		//
	}

	Color::Color(int red, int green, int blue)
		: m_crRedGreenBlue(RGB(red, green, blue))
	{
	}

	Color::Color(COLORREF crRedGreenBlue)
	...
	{
		return (m_crRedGreenBlue == color.m_crRedGreenBlue);
	}
	...
	{
		int iRed = 255 - GetRValue(m_crRedGreenBlue);
		int iGreen = 255 - GetGValue(m_crRedGreenBlue);
		int iBlue = 255 - GetBValue(m_crRedGreenBlue);
